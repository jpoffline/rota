...
$CLS_rota_member = new RotaMember();
...
<html lang="en">
  ...
  <body>
	...
	<div class='container'>
		...
		<h1>
			Member: <?php echo $CLS_rota_member->get_usernamefull() . '//' . $CLS_rota_member->get_rota_type()?>
		</h1>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">My availability // <?php echo $CLS_rota_member->num_days_available().' days' ?></div>
          <?php
